  ...
  return (
    <div className="bg-white">
      <div className="pt-6">
        ...
        {/* Product info */}
        <div className="lg:col-span-1 max-auto mac-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24 ">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className="mt-6">
              ...
              <Rating name="read-only" value={3} readOnly />
                <p className="sr-only">3.0 out of 5 stars</p>
              ...
              <div className="mt-10">
                ...
                <fieldset aria-label="Choose a size" className="mt-4">
                  <RadioGroup
                    ...
                    className="grid grid-cols-3 gap-4 sm:grid-cols-8 lg:grid-cols-4"
                  >
        ...
        <div className="p-10 py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
